...
{
    // directly translating roughness to a gives the BRDF integration map that is identical to Epic Games' version
    float a = roughness;
    // BRDF is slightly different when used alongside IBL as its k variable has a slightly different interpretation
    // kIBL = a*a / 2 
    float k = (a * a) / 2.0;
...
// The two resulting integrals represent a scale and a bias to F0
