...
void Mesh::Bind(DrawableList & drawablelist, Material * material) const
{
	DrawableContext context((IDrawable*)(this), material, modelMat);
	drawablelist.AddContext(context);
}
